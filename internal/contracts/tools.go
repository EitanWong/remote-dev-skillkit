...
func Tools() []Tool {
	...
	return []Tool{
		...
		},
		{
			...
			Description: "Summarize a support session by ticket_code or host_id, select the single active job-ready host when possible, list stale/pending hosts, jobs, artifact counts, and first evidence snippets so Agents can produce final status without hand-written curl or raw HTTP summaries. Pass gateway_url for non-local foreground/tunneled/hosted gateways.",
