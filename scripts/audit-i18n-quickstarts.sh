...
required_patterns=(
  ...
  "Clone or update the repository in a safe user/workspace location."
  "local MCP stdio"
  "Connection Entry"
  "universal target-side handoff"
  "every scenario"
  ...
  "package_catalog"
  "target OS/architecture package candidate"
  "visible fallback script"
  "managed"
  "attended-temporary"
  "do not require a"
  "hosted gateway URL"
  ...
  "rdev deps install"
  "RDEV_*_INSTALL_ACTION_JSON"
  "user/workspace-scoped helper repair"
  "frp"
  "Chisel"
  "headscale"
  "WireGuard"
