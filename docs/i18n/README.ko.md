...
|---|---|
| Skills, MCP tools, file/desktop/task adapters | 가시성, 승인, 철회, 감사 |
| 명확한 capability가 있는 서명된 tasks | 호스트 로컬 policy와 보안 경계 |
| Artifacts와 session evidence | 무엇을 실행하고 언제 멈출지에 대한 통제 |
