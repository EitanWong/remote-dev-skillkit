...
- [ ] Smoke `rdev enrollment sign-certificate`, `rdev enrollment verify-certificate`, `rdev gateway serve --dev --enrollment-root-public-key ...`, and `rdev host serve --enrollment-certificate ...` before making enrollment-certificate support claims.
