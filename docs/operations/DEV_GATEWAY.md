...
- `--identity-store` supports local `0600` JSON files and macOS `keychain:<service>/<account>` references. Production managed hosts still need signed registration proofs and non-macOS protected stores.
