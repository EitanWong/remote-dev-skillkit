...
- Before publishing release artifacts or bootstrap download instructions, create and verify a signed release bundle with `rdev release create-bundle ...` and `rdev release verify-bundle --bundle <bundle> --root-public-key <root>`.
