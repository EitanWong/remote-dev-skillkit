...
- Full production host enrollment authority lifecycle beyond the current local certificate, signed empty revocation baseline, and dev revocation-list distribution primitives: operator roles, CA/key custody, renewal automation, authenticated hosted revocation refresh, emergency drills, and hosted enrollment API.
