...
- Windows temporary acceptance planning via `rdev acceptance windows-temporary`, producing a machine-readable plan, reviewed PowerShell launcher, release verification requirements, approval probes, no-persistence inspection commands, and required evidence checklist without executing PowerShell.
